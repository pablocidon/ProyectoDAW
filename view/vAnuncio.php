            ...
            <form name="perfil" action="index.php?pagina=anuncio&codOferta=<?php echo $_GET['codOferta'];?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php }else {
                            /**
                             * En el caso de que el usuario sea una empresa y seleccione un campo, comprobaremos que está definido,
                             * que no hay mensaje de error y el valor que se habia seleccionado para así mantener la selección el caso
                             * de que haya algún error en algún otro campo.
                             */?>
